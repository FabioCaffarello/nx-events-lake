...
from source_watcher.jobs.handlers.default.html_utils import get_tartget_input_data_by_regex_pattern
...
class Job:
    ...
    def parse_response_body(self, response: requests.Response) -> str:
        ...
        input_search = get_tartget_input_data_by_regex_pattern(response.content, pattern_search)
