...
```sh
npx nx image services-orchestration-services-output-handler --env=<ENVIRONMENT>
```
...
```sh
npx nx go-tidy services-orchestration-services-output-handler
```
...
```sh
npx nx test services-orchestration-services-output-handler
```
