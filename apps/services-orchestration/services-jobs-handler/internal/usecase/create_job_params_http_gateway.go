...
type CreateJobParamsHttpGatewayUseCase struct {
	JobParamsHttpGatewayRepository entity.HttpGatewayParamsInterface
}

func NewCreateJobParamsHttpGatewayUseCase(
	repository entity.HttpGatewayParamsInterface,
) *CreateJobParamsHttpGatewayUseCase {
	return &CreateJobParamsHttpGatewayUseCase{
		JobParamsHttpGatewayRepository: repository,
	}
}

func (ccu *CreateJobParamsHttpGatewayUseCase) Execute(jobParamsHttpGateway inputDTO.HttpGatewayParamsDTO) (outputDTO.HttpGatewayParamsDTO, error) {
