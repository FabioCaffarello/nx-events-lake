...
func (pjd *ProcessingJobDependenciesRepository) Save(processingJobDependencies *entity.ProcessingJobDependencies) error {
...
func (pjd *ProcessingJobDependenciesRepository) Delete(id string) error {
