...
```sh
npx nx image services-orchestration-services-schema-handler --env=<ENVIRONMENT>
```
...
```sh
npx nx go-tidy services-orchestration-services-schema-handler
```
...
```sh
npx nx test services-orchestration-services-schema-handler
```
