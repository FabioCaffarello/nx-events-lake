import { CreateCategoryOutput } from '@nodelib/services/ddd/admin-videos-catalog/category/application/use-cases/create-category';
import { GetCategoryOutput } from '@nodelib/services/ddd/admin-videos-catalog/category/application/use-cases/get-category';
...
import { UpdateCategoryInput, UpdateCategoryOutput } from '@nodelib/services/ddd/admin-videos-catalog/category/application/use-cases/update-category';
