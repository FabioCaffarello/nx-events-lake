...
import { CreateGenreOutput } from '@nodelib/services/ddd/admin-videos-catalog/genre/application/use-cases/create-genre';
import { UpdateGenreOutput } from '@nodelib/services/ddd/admin-videos-catalog/genre/application/use-cases/update-genre';
import { GetGenreOutput } from '@nodelib/services/ddd/admin-videos-catalog/genre/application/use-cases/get-genre';
